...
public class CommentController {
    ...
    /**
     * Endpoint per editar un comentari passat per id que 
     * sigui de l'usuari que fa la petició.
     * @param header Capçalera de la petició http.
     * @param request Paràmetres per editar el comentari.
     * @param id Id del comentari a editar.
     * @return Missatge notificant si s'ha editat o no el comentari.
     */
    @PreAuthorize("hasAnyRole('USER', 'ADMIN', 'GESTOR')")
