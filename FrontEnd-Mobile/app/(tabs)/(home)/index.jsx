...
const Home = () => {
	...
	const handleSearch = () => {
		console.log('Buscar:', searchQuery) // Aquí puedes implementar la lógica de búsqueda
	}
			...
			<FlatList
				ListHeaderComponent={
					<FlatList
						...
						renderItem={({ item }) => (
							<View className='p-4 mx-2 my-4 bg-green-800 rounded-2xl'>
								<Text className='text-lg font-bold text-slate-50'>{item}</Text>
							</View>
						)}
